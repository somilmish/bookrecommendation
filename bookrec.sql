...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 20, 2018 at 09:32 AM
...
--
-- Table structure for table `user_comment_book`
--
...
--
-- Dumping data for table `user_comment_book`
--
...
--
-- Indexes for table `user_comment_book`
--
...
--
-- AUTO_INCREMENT for table `user_comment_book`
--
ALTER TABLE `user_comment_book`
...
--
-- Constraints for table `user_comment_book`
--
ALTER TABLE `user_comment_book`
